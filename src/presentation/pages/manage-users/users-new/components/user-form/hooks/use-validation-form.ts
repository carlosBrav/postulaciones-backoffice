...
export const validateUserForm = yup
  ...
  .shape({
    ...
    idPerfil: yup.string().required('Perfil requerido'),
    numDoc: yup.string().required('Número de documento requerido'),
    codigo: yup.string().required('Código requerido'),
    nombre: yup.string().required('Nombre requerido'),
    apePat: yup.string().required('Apellido Paterno requerido'),
    apeMat: yup.string().required('Apellido Materno requerido'),
